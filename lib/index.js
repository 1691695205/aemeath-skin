...
const SETTINGS_NAMESPACE = "ui-skin-aemeath";
...
function apply(ctx) {
	...
	// alpha.2 settings API: register through ctx.settings.installSection.
	ctx.inject(["settings"], (settingsCtx) => {
		settingsCtx.settings.installSection(ctx, SETTINGS_NAMESPACE, AemeathSettingsSchema, DEFAULTS, {
			setSource: () => {},
			onChange: () => {}
		});
	});
